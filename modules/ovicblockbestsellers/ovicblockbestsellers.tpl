...
<div id="best-sellers_block_right" class="block products_block">
    <h4 class="title_block">
        <a href="{$link->getPageLink('best-sales')|escape:'html'}" title="{l s='View a top sellers products' mod='ovicblockbestsellers'}">
            {l s='Top sellers' mod='ovicblockbestsellers'}
        </a>
    </h4>
    ...
    <div class="block_content">
        {if $best_sellers && $best_sellers|@count > 0}
            ...
            <p class="lnk"><a href="{$link->getPageLink('best-sales')|escape:'html'}"
                              title="{l s='All best sellers' mod='ovicblockbestsellers'}"
                              class="button_large">&raquo; {l s='All best sellers' mod='ovicblockbestsellers'}</a></p>
        {else}
