<section class="home-category hook_homeCategory row clearfix clearBoth">
    <div class="container">
    ...
    <div class="tab-content">
        {if (isset($newproducts)&& $newproducts)}
            <div role="tabpanel" class="tab-pane active newproducts" id="newproducts_{$hook_position}">
                {include file="$tpl_dir./product-list-carousel.tpl" products=$newproducts id="newproducts_list_{$hook_position}"}
            </div>
...
<script type="text/javascript">
$(document).ready(function(){
    $('.home-category.hook_homeCategory .tab-pane.active .owl-item.active ').each(function(i){
