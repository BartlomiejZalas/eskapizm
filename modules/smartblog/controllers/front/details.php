...
class  smartblogDetailsModuleFrontController extends smartblogModuleFrontController
{
	...
	{
           parent::initContent();
		   Hook::exec('actionsbsingle', array('id_post' => (int)Tools::getValue('id_post')));
           ...
           $title_category = $BlogCategory->getNameCategory($id_cate);
            if (file_exists(_PS_MODULE_DIR_.'smartblog/images/' . (int)Tools::getValue('id_post') . '.jpg') )
                {
                   $post_img =  (int)Tools::getValue('id_post');
                }else{
                    $post_img = 'no';
                }
