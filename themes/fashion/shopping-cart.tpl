...
<h1 id="cart_title" class="page-heading">{l s='Shopping cart'}</h1>
...
{include file="$tpl_dir./order-steps.tpl"}
    {if !isset($empty) && !$PS_CATALOG_MODE}
		<div class="heading-counter warning">{l s='Your shopping cart contains:'}
		...
		<table id="cart_summary" class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart_delete last_item"><i class="icon-trash"></i></th>
				</tr>
			</thead>
			<tfoot>
				{if $use_taxes}
