...
$(document).ready(function(){
	...
	var tab_content_id = $('#product-tabs > li:first-child').find('a').attr('href');
	$('#product-tab-content > .tab-pane').removeClass('active');
	if (typeof(tab_content_id) != 'undefined' && tab_content_id.length >0)
		$(tab_content_id).addClass('active');
	else
		$('#product-tab-content > .tab-pane:first-child').addClass('active');
});
...
function refreshProductImages(id_product_attribute)
{
    ...
    // Ovic code / Process height thumb_list_frame
    var thumb_height = $('#thumbs_list_frame >li').height() + 10; //parseInt($('#thumbs_list_frame >li').css('marginBottom'));
	$('#thumbs_list_frame').height((parseInt((thumb_height) * $('#thumbs_list_frame > li').length)) + 'px');
    
    $('#thumbs_list').height(thumb_height*4 + 'px');
	$('#thumbs_list').trigger('goto', 0);
