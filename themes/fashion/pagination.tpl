...
{if isset($p) AND $p}
	...
	{/if}
	<!-- Pagination -->
	<div id="pagination{if isset($paginationId)}_{$paginationId}{/if}" class="pagination clearfix {if !$hide_left_column and !$hide_right_column} both-width{/if}">
    ...
    <div class="product-count {if !$hide_left_column and !$hide_right_column} both-width{/if}">
    	{if ($n*$p) < $nb_products }
