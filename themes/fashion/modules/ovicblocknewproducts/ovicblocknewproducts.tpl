...
<div id="new-products_block_right" class="block products_block">
	<h4 class="title_block">
    	<a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='New products' mod='ovicblocknewproducts'}">{l s='New products' mod='ovicblocknewproducts'}</a>
    </h4>
    <div class="block_content products-block">
        {if $new_products !== false}
            ...
            <div>
                <a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='All new products' mod='ovicblocknewproducts'}" class="btn btn-default button button-small"><span>{l s='All new products' mod='ovicblocknewproducts'}<i class="icon-chevron-right right"></i></span></a>
            </div>
        {else}
