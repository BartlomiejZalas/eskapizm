...
<div id="best-sellers_block_right" class="block products_block">
	<h4 class="title_block">
    	<a href="{$link->getPageLink('best-sales')|escape:'html'}" title="{l s='View a top sellers products' mod='ovicblockbestsellers'}">{l s='Top sellers' mod='ovicblockbestsellers'}</a>
    </h4>
	...
	{if $best_sellers && $best_sellers|@count > 0}
		...
		<div class="lnk">
        	<a href="{$link->getPageLink('best-sales')|escape:'html'}" title="{l s='All best sellers' mod='ovicblockbestsellers'}"  class="btn btn-default button button-small"><span>{l s='All best sellers' mod='ovicblockbestsellers'}<i class="icon-chevron-right right"></i></span></a>
        </div>
	{else}
		<p>{l s='No best sellers at this time' mod='ovicblockbestsellers'}</p>
	{/if}
	</div>
</div>
<!-- /MODULE Block best sellers -->