		...
		<ul id="footer_ul_cms">
			{if !$PS_CATALOG_MODE}
				<li class="item list_style">
					<a class="mainColorHoverOnly" href="{$link->getPageLink('prices-drop')|escape:'html':'UTF-8'}" title="{l s='Specials' mod='blockcms'}">
						{l s='Specials' mod='blockcms'}
					</a>
				</li>
			{/if}
			<li class="item list_style">
				<a class="mainColorHoverOnly" href="{$link->getPageLink('new-products')|escape:'html':'UTF-8'}" title="{l s='New products' mod='blockcms'}">
					{l s='New products' mod='blockcms'}
				</a>
			</li>
			{if !$PS_CATALOG_MODE}
				<li class="item list_style">
					<a class="mainColorHoverOnly" href="{$link->getPageLink('best-sales')|escape:'html':'UTF-8'}" title="{l s='Top sellers' mod='blockcms'}">
			...
			{if $display_stores_footer}
				<li class="item list_style">
					<a class="mainColorHoverOnly" href="{$link->getPageLink('stores')|escape:'html':'UTF-8'}" title="{l s='Our stores' mod='blockcms'}">
						{l s='Our stores' mod='blockcms'}
					</a>
				</li>
			{/if}
			{foreach from=$cmslinks item=cmslink}
				{if $cmslink.meta_title != ''}
					<li class="item list_style">
						<a class="mainColorHoverOnly" href="{$cmslink.link|addslashes|escape:'html':'UTF-8'}" title="{$cmslink.meta_title|escape:'html':'UTF-8'}">
