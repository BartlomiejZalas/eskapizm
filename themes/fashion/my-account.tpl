...
{/if}
<p class="info-account">{l s='Welcome to your account. Here you can manage al of your personal information and orders. '}</p>
...
{if $voucherAllowed || isset($HOOK_CUSTOMER_ACCOUNT) && $HOOK_CUSTOMER_ACCOUNT !=''}
	<div class="col-xs-12 col-sm-6 col-lg-4">
        <ul class="myaccount-link-list">
            ...
            {if $logged}
			<li><a href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html'}" title="{l s='Log me out' mod='blockuserinfo'}" class="logout" rel="nofollow">
                <i class="icon-home"></i>
                <span>{l s='Log out'}</span>
            </a></li>
		    {/if}
        </ul>
    </div>
